...
function chocoFrogCalc(gold){
return Math.floor(gold / 3)
}

let TotalFrogs = chocoFrogCalc(13);
...
//I didn't read ahead! I took this into account when solving the last problem.
